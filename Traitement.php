            ...
            if (isset($message))
            {
                $position_arobase = strpos($mail, '@');
                    if ($position_arobase === false)
                        ...
                        if($retour)
                        echo '<p style="text-align: center">Merci '.$prenom. ' pour votre intéret pour notre projet. Votre message a bien été envoyé. Nous vous répondrons dès que possible. A bientôt !</p>';
                        else
                        echo '<p>Erreur.</p>';
                         }
            }
